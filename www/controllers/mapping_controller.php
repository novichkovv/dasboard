    ...
    public function index_ajax()
    {
        switch($_REQUEST['action']) {
            ...
            case "save_mapping":
                ...
                if(!$_POST['mapping']['user_name'] || !$_POST['mapping']['user_id']) {
                    echo json_encode(array('status' => 2, 'error' => 'All Fields are Required'));
                ...
                } elseif(!$_POST['mapping']['id'] && $this->model('user_mapping')->getByField('user_id', $_POST['mapping']['user_id'])['id']) {
